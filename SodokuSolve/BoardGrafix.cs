...
namespace SodokuSolve
{
    ...
    public class BoardGrafix
    {
        ...
        {
            SodokuBoard.ToggelViewPossibleMoves();
        }


        public bool IsInputFixedValuesModeSet => SodokuBoard.InputFixedValues;

        public void ToggleInputFixedValues()
        {
            SodokuBoard.InputFixedValues = !SodokuBoard.InputFixedValues;
        ...
        public void SetRank(int rank)
        {
            ...
            SodokuBoard.SetRank(CellFocus, rank);
        ...
        {
            SodokuBoard.Select(location);
        }

        public void UnSelect(GridLocation location)
        {
            HasSelection = true;
            SodokuBoard.UnSelect(location);
        }
